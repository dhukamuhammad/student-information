    ...
    <>
      <section id="sidebar" className={isOpen ? "" : "hide"}>
        ...
        <ul className="side-menu top">
          ...
          <li className={location.pathname === "/student_registration" ? "active" : ""}>
            <NavLink to="/student_registration">
              <i className="bx bxs-shopping-bag-alt"></i>
              <span className="text">StudentRegistration</span>
            </NavLink>
          </li>
          <li className={location.pathname === "/coursedetails" ? "active" : ""}>
